...
function populateParameters(result) {var
  brand = result.brand,model = result.model,system = result.system,language = result.language,theme = result.theme,version = result.version,_result$hostName = result.hostName,hostName = _result$hostName === void 0 ? '' : _result$hostName,platform = result.platform;
  var isQuickApp = "mp-weixin".indexOf('quickapp-webview') !== -1;
  ...
  // deviceModel
  var deviceBrand = model.split(' ')[0].toLocaleLowerCase();
  if (isQuickApp) {
  ...
  var parameters = {
    ...
    appVersion: "1.0.0",
    appVersionCode: "100",
    uniCompileVersion: "3.4.12",
    uniRuntimeVersion: "3.4.12",
